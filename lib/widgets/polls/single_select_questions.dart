...
class SingleSelectQuestions extends StatefulWidget {
  final String question;
  final List<Choice> choices;

  const SingleSelectQuestions({Key key,@required this.question, @required this.choices}) : super(key: key);

  @override
  _SingleSelectState createState() => _SingleSelectState();
}

class _SingleSelectState extends State<SingleSelectQuestions> {
  final GroupController controller = GroupController(isMultipleSelection: false);
  var value = '';
